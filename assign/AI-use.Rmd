...
* **Understand any code** produced by AI, so that you would be able to do something similar yourself without any assistance. That might mean looking up the documentation for functions used and understanding the arguments that control the output.
...
An exception is if, for a project you want to explicitly study AI itself. 
