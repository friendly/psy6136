...
* Bluesky: [@datavisFriendly.bsky.social](https://bsky.app/profile/datavisfriendly.bsky.social)
* GitHub stuff: [GitHub ](https://github.com/friendly)
* Office: 226 BSB (Thu/Fri only)
* Office hours: Thursday: 11:00-1:00, but by appointment
...
* Thursday, 11:30 am - 2:30 pm, Rm 203 BSB.
As might be useful, some classes might meet in the Hebb Lab, 159 BSB
...
ungraded. Like the tutorials, they are meant to give practice in working with categorical data,
but give a chance for corrective feedback when you submit your work.

In these assignments, you are free to collaborate / brainstorm with other students in the class,
if you can help each other

They are usually due in two weeks from when announced.
Details regarding a useful way of
...
Here's a [template for an R script](assign/RScript-template.R) that shows how you add headings
and text to produce readable output in Word, HTML, ... Here is the [result, when you "knit"](assign/RScript-template.html) the script to HTML.


Please submit your assignments to me by email, as a PDF, Word, or HTML attachment
(together with the associated R or Rmd file),
with
a Subject: line "**PSY 6136: Assignment XX**".
...
* [Assignment 1](assign/assign1.pdf) 
  <!-- || Some answers: [ans1.R](assign/ans1.R) | [ans1.html](assign/ans1.html)  -->
* [Assignment 2](assign/assign2.pdf) 
  <!-- || Some answers: [ans2.R](assign/ans2.R) | [ans2.html](assign/ans2.html)  -->
* [Assignment 3](assign/assign3.pdf) 
  <!-- || Some answers: [asn3.R](assign/ans3.R) | [ans3.html](assign/ans3.html) -->
...
This year, I'd also like to welcome any of you who want to earn their
grade (or a portion) by taking a role in development of software for categorical
data analysis, with the [`vcdExtra` package](https://friendly.github.io/vcdExtra/), or something else. More on this later.
...
**AI Usage Policy**: Students may use AI tools for R programming assistance with proper disclosure. See the [AI Usage Guidelines](assign/AI-use.html) for complete details on permitted and prohibited uses.

**The details of these projects** will likely be revised! The links show what they were in the previous version of this course.

1. [Project 1](assign/project1.pdf):
a selection of data sets for the material up to and including logistic regression. Due date: Feb. 24 (but earlier appreciated)

2. [Project 2](assign/project2.pdf):
a selection of data sets for the material from logistic regression to the end of the course. Due date: Mar. 31

3. The remaining 40% can be earned as a research paper / project extending the scope of CDA in some way.
Some sample project topics are described in  [6136 Individual or Team Projects](assign/projects6136.html)
For this, I would like to receive an email from you describing what you propose to do, say, by the 
end of Reading Week, Frb. 20. 
...
The lecture slides, tutorials and R scripts linked here are available under a [Creative Commons Attribution-NonCommercial-ShareAlike](https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode) license. They are available to everybody under the terms of this license and can be shared. This means that you
can re-use these materials for non-commercial purposes as long as all uses include an appropriate credit to 
this source.
